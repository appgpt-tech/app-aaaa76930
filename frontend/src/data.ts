...
let data: any = {
  defaultData: {
    ...
    OrderDetails: [
      { orderNumber: 1, line: 1, product: 1, price: 0.77, quantity: 1, id: 70 },
      { orderNumber: 2, line: 2, product: 2, price: 0.48, quantity: 2, id: 36 },
      { orderNumber: 3, line: 3, product: 3, price: 0.6, quantity: 3, id: 70 },
      { orderNumber: 4, line: 4, product: 4, price: 0.81, quantity: 4, id: 62 },
      { orderNumber: 5, line: 5, product: 5, price: 0.46, quantity: 5, id: 82 },
    ],
    Payments: [
      {
        orderNumber: 1,
